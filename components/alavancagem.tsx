...
import {leverageEntries,nextLeverage,resetStakeFor,leverageNet,type Group} from '@/lib/alavancagem';
...
function LeverageRegister({rows,disabled,onUpdated,group}:PanelProps&{group:Group}){
 ...
 const groupLabel=group==='individual'?'Individual':'Alavancagem 1,3';
 return <div>
  <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',gap:12,flexWrap:'wrap'}}>
   <p className="hint" style={{margin:0,flex:'1 1 260px'}}>Registros {groupLabel} · Histórico e sequência de stakes independentes.{group==='alavancagem'&&' Cada entrada registrada aqui gera automaticamente uma entrada espelhada em Individual, com a stake padrão configurada.'}</p>
